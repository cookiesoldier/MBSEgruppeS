 ...
 * </p>
 * <ul>
 *   <li>{@link mbse.tutorial.yawl.Transition#getSplit <em>Split</em>}</li>
 *   <li>{@link mbse.tutorial.yawl.Transition#getJoin <em>Join</em>}</li>
 * </ul>
 *
 * @see mbse.tutorial.yawl.YawlPackage#getTransition()
 * @model
 * @generated
 */
public interface Transition extends org.pnml.tools.epnk.pnmlcoremodel.Transition {
	 ...
	 * @see mbse.tutorial.yawl.YawlPackage#getTransition_Split()
	...
	/**
	 * Sets the value of the '{@link mbse.tutorial.yawl.Transition#getSplit <em>Split</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see mbse.tutorial.yawl.YawlPackage#getTransition_Join()
	 * @model containment="true"
	 * @generated
	 */
	ControlType getJoin();
	...
	/**
	 * Sets the value of the '{@link mbse.tutorial.yawl.Transition#getJoin <em>Join</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
